...
if len(sys.argv) == 1:
    ...
    if target == '--update' or target == '-u' or target == '--u':
        ...
        os.system(
            'wget -N https://github.com/Malwareman007/Open_Source_Web-Vulnerability-Scanner-and-Patcher/tree/main/Full%20Scanner/Web_scan.py -O Web_scan.py.py > /dev/null 2>&1')
